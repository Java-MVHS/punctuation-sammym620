/* Sammy Mukkamala  
   ...
   P6  
   Punctuation.java  
   Purpose of this code is to find all the punctuation and print it out.  
*/

public class Punctuation
{
    private String text = "Blood, Sweat, and Tears by Winston Churchill " +
        "May 13, 1940 " +
        "Mr. Speaker: " +
    ...
    public static void main(String[] args)
    {
        ...
        punc.searchForPunctuation();
    }

    public void searchForPunctuation()
    {
        findPunctuationWords();
        printResults(result);
    }

    private void findPunctuationWords()
    {
        int lastIndex = -1;
        ...
        for (int i = 0; i < text.length(); i++)
        {
            ...
            {
                result += analyzePunctuation(text.substring(lastIndex + 1, i));
                lastIndex = i;
            }
        }
    }

    private String analyzePunctuation(String word)
    {
        String trimmedWord = word.trim();
        for (char ch : trimmedWord.toCharArray())
        {
    ...
    private void printResults(String words)
    {
        System.out.println("The following words contain punctuation:");
        System.out.println(words);
        System.out.printf("Total words with punctuation: %d\n", totalCount);
    }
}
