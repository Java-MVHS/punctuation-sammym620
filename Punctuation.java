public class Punctuation
{
    ...
    {
        // Text containing multiple sentences with punctuation
        ...
        // Call the method to process and search for words with punctuation
        searchIt(text);
    }

    public static void searchIt(String text)
    {
        // Find all words with punctuation
        String[] wordsWithPunctuation = getPunctuationWords(text);
        // Print the words with punctuation
        printWords(wordsWithPunctuation);
    }
    ...
    public static String[] getPunctuationWords(String text)
    {
        ...
        // Create an array to store words with punctuation
    ...
    public static boolean checkForPunctuation(String word)
    {
        ...
        {
            // If the character is a punctuation mark, return true
            if (".,;:!?\"'()[]{}-—“”‘’".indexOf(c) != -1)
            {
                return true;
            }
